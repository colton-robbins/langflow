...
class MemoryComponent(Component):
    ...
    outputs = [
        ...
        Output(display_name="Data", name="messages_data", method="retrieve_messages", dynamic=True),
    ]
        ...
        if field_name == "mode":
            ...
            if field_value == "Retrieve":
                frontend_node["outputs"] = [
                    ...
                    Output(
                        display_name="Data", name="messages_data", method="retrieve_messages", dynamic=True
                    ),
                ]
